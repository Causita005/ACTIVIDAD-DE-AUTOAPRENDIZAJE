...
public class Player : MonoBehaviour
{
    ...
    float accelerationTimeAirborne = .15f;  // Tiempo para alcanzar la velocidad máxima en el aire
    ...
    float gravity=-30f;  // Gravedad aplicada al jugador
    ...
    public void OnJumpInputDown()
    {
        ...
        if (controller.collisions.below)
        {
            ...
            {
                // Aquí puedes probar con maxJumpVelocity * 1.2f para darle un poco más de impulso
